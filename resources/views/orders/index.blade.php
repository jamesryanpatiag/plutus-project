        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <form action="{{route('orders.index')}}">
                    <div class="row">
                        <div class="col-md-4">
                            <input type="text" name="search" class="form-control" value="{{request('search')}}" placeholder="Type Keyword..."/>
                        </div>
                        <div class="col-md-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button class="btn btn-sm btn-danger btn-delete" data-url="{{route('orders.destroy', $order)}}"><i class="fas fa-trash"></i></button>
